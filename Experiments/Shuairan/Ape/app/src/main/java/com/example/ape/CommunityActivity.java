...
public class CommunityActivity extends AppCompatActivity{
    ...
    public void setposting(final String storetype, String url1, final String url2){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url1, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try{
                    ...
                    for(int i=0; i < datalist.size(); i++){
                        JSONObject jdata = new JSONObject((String) datalist.get(i));
                        final String postid = jdata.optString("usersId");
                        final int index = i;
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, url2, new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                try{
                                    ...
                                    String uname = jdata.optString("posttitle");
                                    String pid = jdata.optString("id");
