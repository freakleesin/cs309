 ...
 */
public class StoreAddFriendsActivity extends AppCompatActivity {
    String TAG = "MyTAG";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.store_add_friends_site);
        Log.d(TAG, "onCreate: ");
            ...
            public void onClick(View view){
                ...
                if(!friendsusername.isEmpty() && !confriendsusername.isEmpty()){
                    if(friendsusername.equals(confriendsusername)) {
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url_cu, new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    if (code.equals("fail")) {
                                        Toast.makeText(StoreAddFriendsActivity.this, "Add Fail!", Toast.LENGTH_SHORT).show();
                                        clearinformation();
                                    } else{
                                        Toast.makeText(StoreAddFriendsActivity.this, "Add Success!", Toast.LENGTH_SHORT).show();
                                        clearinformation();
                                        Intent intent = new Intent(StoreAddFriendsActivity.this, PersonalCenterActivity.class);
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(StoreAddFriendsActivity.this, "Response Error!", Toast.LENGTH_SHORT).show();
                            }
                        }) {
                            @Override
                        ...
                        Toast.makeText(StoreAddFriendsActivity.this, "Input Wrong!", Toast.LENGTH_SHORT).show();
                        clearinformation();
                    }
                }
                else{
                    Toast.makeText(StoreAddFriendsActivity.this, "Input Empty!", Toast.LENGTH_SHORT).show();
                    clearinformation();
                }
            }
        });
        ...
        bcommunity.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Intent intent = new Intent(StoreAddFriendsActivity.this, StoreCommunityActivity.class);
                intent.putExtra("id",id);
                intent.putExtra("username", username);
                startActivity(intent);
            }
        ...
        bhome.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Intent intent = new Intent(StoreAddFriendsActivity.this, StoreHomeActivity.class);
                intent.putExtra("id",id);
                intent.putExtra("username", username);
                startActivity(intent);
            }
        ...
        bperson.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Intent intent = new Intent(StoreAddFriendsActivity.this, StoreCenterActivity.class);
                intent.putExtra("id",id);
                intent.putExtra("username", username);
                startActivity(intent);
            }
